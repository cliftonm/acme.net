...
namespace Oocx.ACME.Console
{
	public class Options
	{
		...
		[Option('d', "domain", Separator = ':', HelpText = "The names of the domains for which you want to request a certificate.", Required = true)]
		public IEnumerable<string> Domains { get; set; }

		[Option('a', "acceptTermsOfService", HelpText = "Accept the terms of service of the ACME server")]
		public bool AcceptTermsOfService { get; set; }

		[Option('t', "termsOfServiceUri", HelpText = "The uri of the terms of service that you accept.", Default = "https://letsencrypt.org/documents/LE-SA-v1.1.1-August-1-2016.pdf")]
